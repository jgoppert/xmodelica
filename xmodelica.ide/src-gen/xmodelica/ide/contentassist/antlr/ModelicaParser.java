		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassSpecifierAccess().getNameAssignment_0(), "rule__ClassSpecifier__NameAssignment_0");
					put(grammarAccess.getClassSpecifierAccess().getCommentAssignment_1(), "rule__ClassSpecifier__CommentAssignment_1");
					put(grammarAccess.getClassSpecifierAccess().getCompositionAssignment_2(), "rule__ClassSpecifier__CompositionAssignment_2");
					put(grammarAccess.getClassSpecifierAccess().getName_endAssignment_4(), "rule__ClassSpecifier__Name_endAssignment_4");
					...
					put(grammarAccess.getArithmeticExpressionAccess().getOpsAssignment_1_1(), "rule__ArithmeticExpression__OpsAssignment_1_1");
					put(grammarAccess.getArithmeticExpressionAccess().getTermsAssignment_1_2(), "rule__ArithmeticExpression__TermsAssignment_1_2");
					put(grammarAccess.getTermAccess().getOpsAssignment_1_1(), "rule__Term__OpsAssignment_1_1");
